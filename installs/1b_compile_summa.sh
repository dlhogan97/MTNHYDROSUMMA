...
dest_line=$(grep -m 1 "^install_path_summa" ../0_config_files/control_active.txt) # full settings line
...
exe_line=$(grep -m 1 "^exe_name_summa" ../0_config_files/control_active.txt) 
...
# --- Library settings
# Set library include and link paths manually (adjust if different on your system)
export INCLUDES="-I/usr/include -I/usr/include/netcdf" 
